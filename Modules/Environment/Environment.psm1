...
function Set-Prompt {
    ...
    param(
       ...
       # Some things goes OUTSIDE the prompt function because it doesn't need re-evaluation

       # I set the title in my prompt every time, because I want the current PATH location there,
       # rather than in my prompt where it takes up too much spaaaaaace.

       # But I want other things too. I  calculate an initial prefix for the window title
